...
@eval_context
def humanize_precisetime(eval_ctx, value, minimum_unit="seconds", suppress=(), format="%d", when=None):
	return precisetime(value, minimum_unit=minimum_unit, suppress=suppress, format=format, when=when)
...
class HumanizeExtension(Extension):
	def __init__(self, environment):
		...
		environment.filters["humanize_precisetime"] = humanize_precisetime
